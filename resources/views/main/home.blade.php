...
<section class="ftco-section ftco-consult ftco-no-pt ftco-no-pb" style="background-image: url({{asset("assets/images/bg_5.jpg")}})"
                ...
                <div class="py-md-5">
                    ...
                    <form action="{{route('quote.store')}}" method="POST" class="appointment-form ftco-animate">
                        ...
                        <div class="d-md-flex">
                            ...
                            <div class="form-group ">
                                <textarea name="message" id="" cols="30" rows="2" class="form-control" placeholder="{{__("Message")}}"></textarea>
                            </div>
                        ...
                        <div class="d-md-flex">
                            ...
                            <div class="form-group">
                                <input type="text" type="phone" name="phone" class="form-control" placeholder="{{__("Phone")}}" />
                            </div>
                            <div class="form-group ml-md-4">
                                {{-- <input type="submit" value="Request A Quote"
                                    class="btn btn-primary py-3 px-4" /> --}}
                                    <button type="submit"  class="btn btn-primary py-3 px-4" > {{__("Request A Quote")}} </button>
                            </div>
                        </div>
                    </form>
                </div>
