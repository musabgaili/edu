                ...
                <div class="row align-items-center">
                    <div class="col-xl-6 col-lg-7 col-md-8">
                        <div class="hero__caption">
                            ...
                            <h1 data-animation="fadeInLeft" data-delay=".4s">{{__("An unprecedented learning experience")}}</h1>
                            <!-- Hero-btn -->
                            <div class="hero__btn">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="about-caption mb-50">
                    ...
                    <p>
                        ...
                        It is a digital manufacturing laboratory designed to encourage the community to come and turn their ideas and innovations into reality.
                        The factory contains the latest digital manufacturing machines, various machines, and specialized engineers with knowledge and
                        experience.
                    <ul>
